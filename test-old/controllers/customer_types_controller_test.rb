...
class CustomerTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create customer_type" do
    assert_difference("CustomerType.count") do
      post customer_types_url, params: { customer_type: { description: @customer_type.description, name: @customer_type.name } }
    end
  ...
  test "should update customer_type" do
    patch customer_type_url(@customer_type), params: { customer_type: { description: @customer_type.description, name: @customer_type.name } }
