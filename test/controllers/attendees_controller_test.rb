...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference("Attendee.count") do
      post attendees_url, params: { attendee: { company: @attendee.company, email: @attendee.email, first_name: @attendee.first_name, last_name: @attendee.last_name, mobile_number: @attendee.mobile_number } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { company: @attendee.company, email: @attendee.email, first_name: @attendee.first_name, last_name: @attendee.last_name, mobile_number: @attendee.mobile_number } }
