...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference("Agenda.count") do
      post agendas_url, params: { agenda: { item: @agenda.item, meeting_id: @agenda.meeting_id } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { item: @agenda.item, meeting_id: @agenda.meeting_id } }
